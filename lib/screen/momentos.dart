...
class MomentosHome extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => Momentos();
}

class Momentos extends State<MomentosHome> {
  List<Palabra> momentos= List<Palabra>();

  static Future <List<Palabra>> loadJsonData() async {
    var palabras= List<Palabra>();
    var response= await rootBundle.loadString('bdd/momentos.json');
